...
ENG_STARTER_L                          = CreateGauge("parameter")
ENG_STARTER_L.arg_number               = 504
ENG_STARTER_L.input                    = {-1.0, 1.0}
ENG_STARTER_L.output                   = {-1.0, 1.0}
ENG_STARTER_L.parameter_name           = "ENG_STARTER_L"
