...
elements["L_ENG_MASTER"]                        = default_animated_lever("Left Engine Master",                  devices.ENGINES_CONTROL_SYSTEM,     device_commands.ENG_MASTER_L,498,0.8,{0,1})
elements["R_ENG_MASTER"]                        = default_animated_lever("Right Engine Master",                 devices.ENGINES_CONTROL_SYSTEM,     device_commands.ENG_MASTER_R,499,0.8,{0,1})
elements["JET_FUEL_STARTER"]                    = default_2_position_tumb("Jet Fuel Starter",
                                                                                                                devices.ENGINES_CONTROL_SYSTEM,     device_commands.ENG_JFS,503)
elements["TMB_ENG_START_L"]                     = default_3_position_tumb("Engine Left\nFuel Flow ",            devices.ENGINES_CONTROL_SYSTEM,     device_commands.ENG_FF_L,411)
elements["TMB_ENG_START_L"].arg_lim             = {{-1, 1}, {-1, 1}} 
elements["TMB_ENG_START_R"]                     = default_3_position_tumb("Engine Right\nFuel Flow",            devices.ENGINES_CONTROL_SYSTEM,     device_commands.ENG_FF_R,412) 
...
elements["TMB_FUEL_OPEN/CLOSE"]                 = default_2_position_tumb("Refueling port",                     devices.FUEL_CONTROL_SYSTEM,        device_commands.FUEL_REFUEL,435) 
elements["TMB_FUEL_OPEN/CLOSE"].arg_lim         = {{-1, 1}, {-1, 1}} 
